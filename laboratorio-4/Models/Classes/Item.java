...
public class Item {
    ...
    public Item(String nome, int bonusPoder, int valor, TipoItemEnum tipo, boolean itemGrande, LinkedList<ClasseEnum> classesCompativeis, LinkedList<RacaEnum> racasCompativeis) {
        this.nome = nome;
